...
/* ───────────── Mini Pitch — position indicator for player header ───────────── */
...
function PitchCanvas({ primaryPosition, secondaryPosition, tertiaryPosition, size }: PitchProps) {
  const isSm = size === 'sm';
...
function MiniPitch({ primaryPosition, secondaryPosition, tertiaryPosition }: MiniPitchProps) {
  return (
    <div className="group relative">
      ...
      <div className="pointer-events-none absolute right-0 top-full z-50 mt-2 opacity-0 transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
